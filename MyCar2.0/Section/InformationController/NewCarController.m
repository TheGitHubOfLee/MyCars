...
- (void)addRefreshAndMore {
    self.tableView.mj_header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        self.isDown = YES;
        self.page = 1;
        [self paseDataWithURL:[NSString stringWithFormat:kNewCarUrl, self.page]];
    }];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    detailVC.detailStr = [NSString stringWithFormat:kDetailUrl2, model.newsId];
//    NSLog(@"%@", detailVC.detailStr);
